        ...
        <?php elseif($lvls==='0'): ?>
          <form action="<?php echo site_url('welcome/updateKriteria'); ?>" method="post">
            <?php foreach ($absen as $ab){ ?>
              <div class="header">
                <h4 class="title">Ubah Kriteria Absen <?php echo $ab->nama_absen; ?></h4>
              </div>
              <table class="table table-hover table-striped">
                <tr>
                  <td><label class="control-label" for="id_absen">ID Kriteria Absen</label></td>
                  <td><input class="form-control" id="id_absen" name="id_absen" type="text" value="<?php echo $ab->id_absen; ?>" readonly></td>
                </tr>
                <tr>
                  <td><label class="control-label" for="nama_absen">Nama Kriteria Absen</label></td>
              ...
              <table class="table">
                <tr>
                  <td colspan="2">
                  <a href="javascript:history.back()" id="cancel" name="cancel" class="btn btn-fill btn-warning">Kembali</a>
                    <button class="btn-fill btn btn-info" type="submit">Simpan</button>
                  </td>
                </tr>
              </table>
            </form>
