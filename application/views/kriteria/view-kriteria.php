    ...
    <div class="card card-plain">
      <div class="content table-responsive table-full-width">
          <table class="table table-hover table-striped">
            <div class="header">
              <h4 class="title">Kriteria Kinerja Karyawan</h4>
            </div>
          <tr>
          ...
          foreach ($data_kriteria as $dk) {
            ?>
              <tr>
                ...
                <td><?php echo $num; ?></td>
                <td><a class="btn-fill btn-warning btn pe-7s-config" href="<?php echo site_url('HR/chkrit_pg/' . $dk->id_kriteria); ?>" title="Ubah"></a>&nbsp<a class="btn-fill btn-danger btn pe-7s-close" href="<?php echo site_url('HR/delKrit/' . $dk->id_kriteria); ?>" title="Hapus"></a></td>
              </tr>
              <?php $num++;
            } ?>
          </table>
