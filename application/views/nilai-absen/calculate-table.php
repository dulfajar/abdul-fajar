            ...
            <div class="row">
              <div class="col-md-7">
                <div class="form-group">
                  ...
                  <button class="btn btn-info btn-fill" onclick="getPDF();" name="button"><i class="pe-7s-print"></i>&nbsp&nbsp Unduh Tabel</button>
                  <button id="printY" class="btn btn-info btn-fill" onclick="printData();" name="button"><i class="pe-7s-print"></i>&nbsp&nbsp Print</button>
        ...
        <table class="table table-hover table-striped">
          ...
          <tbody>
            <?php foreach ($listKrit as $bc):
              ...
              <tr>
                  <?php
                  $this->db->from('analisa_absen');
                  $this->db->where('absen_x',$bc->id_absen);
                  $query=$this->db->get();
                  $anK=$query->result();
                  ?>
                  <td><b><?php echo $bc->nama_absen; ?></b></td>
...
<!-- Rasio Konsistensi -->
        <form class="" action="<?php echo base_url('welcome/updateNiAb'); ?>" method="post" onsubmit="return check()">
          <div class="header">
            ...
            <tbody>
              <?php foreach ($listKrit as $bc):
                ...
                <tr>
                    ...
                    <td hidden><input id="id_absen" type="text" name="id_absen[<?php echo $rx; ?>]" value="<?php echo $bc->id_absen; ?>"></td>
              ...
              <table class="table">
                <tr>
                  <td colspan="4">
                    ...
                    <input type="submit" class="btn btn-fill btn-info" name="" value="Simpan Ke Database" >
                   </td>
                </tr>
              </table>
            </form>
