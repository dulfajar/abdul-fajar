          ...
          foreach ($data_kriteria as $dk){
            ?>
              <tr>
                ...
                <td><?php echo $num; ?></td>
                <td><a class="btn-fill btn-warning btn pe-7s-config" href="<?php echo site_url('welcome/chkrit_pg/'.$dk->id_absen); ?>" title="Ubah"></a>&nbsp<a class="btn-fill btn-danger btn pe-7s-close" href="<?php echo site_url('welcome/delAbs/'.$dk->id_absen); ?>" title="Hapus"></a></td>
              </tr>
              <?php $num++;
            }?>
          </table>
