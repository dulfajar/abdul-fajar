  ...
  <div class="card">
    <div class="card card-plain">
      <div class="content table-responsive table-full-width">
        <div class="header">
          <h4 class="title">Ubah Prioritas Kriteria Kriteria Kinerja Karyawan</h4>
        </div>
        ...
        <?php }
          ...
          <tr>
            <td colspan="4">
              ...
              <button type="submit" class="btn btn-fill btn-info" ><i class="pe-7s-calculator"></i>&nbsp&nbspKalkulasi</button>
            </td>
          </tr>
          </tbody>
          </table>
